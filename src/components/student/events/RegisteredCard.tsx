  ...
  return (
    <section className="text-gray-900 flex items-center justify-center ">
      <div className="flex rounded-3xl bg-white items-center justify-center  h-40 overflow-y-hidden">
        ...
        <div className="relative h-40 flex flex-xcol items-center border-dashed justify-between border-[0.5px] bg-zinc-900 ">
        ...
        <div className="h-40  border gap-2 bg-white   py-8 px-8  justify-between  items-start rounded-r-3xl flex flex-col">
